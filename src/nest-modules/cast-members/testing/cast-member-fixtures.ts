...
export class CreateCastMemberFixture {
	...
	static arrangeForCreate() {
		const faker = CastMember.fake().oneActor().withName("Member");
		return [
			{
				send_data: {
					name: faker.name,
...
export class ListCastMembersFixture {
	...
	static arrangeUnsorted() {
		...
		const arrange_searchTerm_actors_sort_by_created_desc = [
			{
				send_data: {
					page: 1,
					per_page: 2,
		...
		const arrange_searchTerm_directors_sort_by_created_desc = [
			{
				send_data: {
					page: 1,
					per_page: 2,
		...
		return {
			arrange: [
				...
				...arrange_searchTerm_actors_sort_by_created_desc,
				...arrange_searchTerm_directors_sort_by_created_desc,
			],
			entitiesMap,
		};
	}
