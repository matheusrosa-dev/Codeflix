...
import { ProcessAudioVideoMediasInput } from "@core/video/app/use-cases/process-audio-video-medias/process-audio-video-medias.input";
import { Status } from "@core/shared/domain/value-objects/audio-video-media.vo";
...
export class VideosConsumers {
	...
	async onProcessVideo(msg: {
		...
		const input = new ProcessAudioVideoMediasInput({
			...
			status: msg.video?.status as Status,
		});
