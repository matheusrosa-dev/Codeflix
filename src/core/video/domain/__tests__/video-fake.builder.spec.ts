...
describe("VideoFakerBuilder Unit Tests", () => {
	describe("video_id prop", () => {
		...
		test("should pass index to video_id factory", () => {
			...
			const fakerMany = VideoFakeBuilder.manyVideosWithoutMedias(2);
	...
	describe("created_at prop", () => {
		...
		test("should throw error when any with methods has called", () => {
			const fakerVideo = VideoFakeBuilder.oneVideoWithoutMedias();
	...
	it("should create a video without medias", () => {
		let video = VideoFakeBuilder.oneVideoWithoutMedias().build();
		...
		video = VideoFakeBuilder.oneVideoWithoutMedias()
			.withVideoId(videoId)
			.withTitle("name test")
	...
	it("should create a video with medias", () => {
		let video = VideoFakeBuilder.oneVideoWithAllMedias().build();
		...
		video = VideoFakeBuilder.oneVideoWithAllMedias()
			.withVideoId(videoId)
			.withTitle("name test")
			.withDescription("description test")
			.withYearLaunched(2020)
	...
	it("should create many videos without medias", () => {
		...
		const castMemberId1 = new CastMemberId();
		const castMemberId2 = new CastMemberId();
		videos = VideoFakeBuilder.manyVideosWithoutMedias(2)
			.withVideoId(videoId)
			.withTitle("name test")
			.withDescription("description test")
			.withYearLaunched(2020)
	...
	it("should create many videos with medias", () => {
		...
		videos = VideoFakeBuilder.manyVideosWithAllMedias(2)
			.withVideoId(videoId)
			.withTitle("name test")
			.withDescription("description test")
			.withYearLaunched(2020)
