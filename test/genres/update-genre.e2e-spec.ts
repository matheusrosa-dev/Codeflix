...
import { UpdateGenreFixture } from "../../src/nest-modules/genres/testing/genre-fixture";
...
import { GenreOutputMapper } from "../../src/core/genre/app/use-cases/common/genre-output";
...
describe("GenresController (e2e)", () => {
	...
	describe("/genres/:id (PATCH)", () => {
		describe("should a response error when id is invalid or not found", () => {
			...
			const arrange = [
				{
					...
					expected: {
						message:
							"Genre Not Found using IDs: 88ff2587-ce5a-4769-a8c6-1d63d29c5f7a",
						statusCode: 404,
						error: "Not Found",
					},
				},
			...
			test.each(arrange)("when id is $id", async ({
				id,
				send_data,
				expected,
			}) => {
